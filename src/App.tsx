...
function AuthenticatedApp() {
  ...
  return (
    <FinanceProvider>
      <SidebarProvider>
        <div className="min-h-screen flex w-full bg-gradient-to-br from-blue-50/50 via-sky-50/30 to-indigo-50/40 dark:from-[hsl(270,40%,8%)] dark:via-[hsl(275,35%,12%)] dark:to-[hsl(265,30%,10%)]">
          <AppSidebar />
